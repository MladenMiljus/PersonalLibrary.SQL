...
IF OBJECT_ID('dbo.CodebookCountries', 'U') IS NOT NULL
	--DROP TABLE dbo.CodebookCountries
	SELECT TOP 100 * FROM dbo.CodebookCountries
ELSE
BEGIN
	CREATE TABLE dbo.CodebookCountries
	(
		ID SMALLINT IDENTITY(1,1),
		BlaID INT, /* just put in because of data sample - will be erased later */
		CountryName VARCHAR(80) NOT NULL, /* English language used for default - expand with localizations like for other codebooks */
		Code2 CHAR(2) UNIQUE NOT NULL,
		Code3 CHAR(3) UNIQUE NOT NULL,
		Active BIT DEFAULT 1,
		CONSTRAINT PK_CodebookCountries_ID PRIMARY KEY (ID)
	)

	INSERT INTO dbo.CodebookCountries (BlaID, CountryName, Code2, Code3)
